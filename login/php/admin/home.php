   ...
   <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #021631;">
    ...
    <div class="container">
      ...
      <div class="container d-flex justify-content-center">
        <div class="row w-40">
            <a class="col btn" href="#" style="background-color: #b0d2ff; width: 220px; height:220px;">
            ...
            <a class="col btn" href="./cataloger.php" style="background-color: #b0d2ff; width: 220px; height:220px;">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" style="width: 150px; height:150px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div class="col w-2"></div> 
            <a class="col btn" href="./manage_user.php" style="background-color: #b0d2ff; width: 220px; height:220px;">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" style="width: 150px; height:150px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div class="container d-flex justify-content-center">
          <div class="row w-40">
            <a class="col btn " href="./library_event.php" style="background-color: #b0d2ff; width: 220px; height:220px;">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" style="width: 150px; height:150px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
