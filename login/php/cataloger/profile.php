...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #021631;">
            <div>
                <a class="nav-link fw-bold text-light" href="/consulta/login/php/cataloger/cataloger.php">Home</a>
            </div>
            <div class="container d-flex justify-content-end ">
                <a class="navbar-brand m-0 p-0" href="/consulta/login/php/cataloger/profile.php">
                ...
                <ul class="nav nav-tabs ms-0">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-light" style="background-color: #021631;" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Cataloger</a>
        ...
        <div class="container d-flex rounded bg-white mt-5 mb-5 justify-content-center">
                <div class="col-md-5 border-right">
                    <div class="p-3 py-5">
                        ...
                        <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="" width="150px" src="../reverted_cataloger.png"><span class="font-weight-bold">Cataloger</span><span class="text-black-50">cataloger@wmsu.com</span><span> </span></div>
                        <div class="row">
